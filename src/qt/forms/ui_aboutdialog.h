...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("Copyright &copy; 2009-YYYY The Bitcoin Core developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bitcoin Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bitcoin Core</b> version", 0));
